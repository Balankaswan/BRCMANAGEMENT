...
export const generateMemoPDF = async (memo: Memo, loadingSlip: LoadingSlip, bankingEntries?: any[], cashbookEntries?: any[], options?: { preview?: boolean }): Promise<string | void> => {
...
export const generateBillPDF = async (bill: Bill, loadingSlip: LoadingSlip, bankingEntries?: any[], cashbookEntries?: any[], options?: { preview?: boolean }): Promise<string | void> => {
