      ...
      try {
        ...
        try {
          ...
          if (ledgerResponse.ledgerEntries) {
            ...
            console.log('✅ Manually refreshed ledger entries after fuel allocation:', ledgerResponse.ledgerEntries.length);
          }
        } catch (syncError) {
          console.error('❌ Failed to manually sync ledger entries:', syncError);
        }
